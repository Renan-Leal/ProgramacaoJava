...
public class Cozinha_FornoEletrico {
	...
	public static void main(String[] args) {
		...
		FornoEletrico fornoEletrico = new FornoEletrico("Forno de Embutir Elétrico", "Grill Timer", 50, 1.5);
		
		double consumoDiario = fogao.calcularConsumoKwDia(10) + geladeira.calcularConsumoKwDia(10) + 
				lavaLouca.calcularConsumoKwDia(10) + microOndas.calcularConsumoKwDia(10) + fornoEletrico.calcularConsumoKwDia(10);
		
		double consumoMensal = fogao.calcularConsumoKwMes() + geladeira.calcularConsumoKwMes() + 
				lavaLouca.calcularConsumoKwMes() + microOndas.calcularConsumoKwMes() + fornoEletrico.calcularConsumoKwMes();
